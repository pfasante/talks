...
\begin{frame}{Substitution Permutation Networks}{The most common design structure for block ciphers}
    ...
    \begin{minipage}{0.475\textwidth}
        \begin{itemize}
            ...
            \item Linear layer $P : \F_2^{kn} \to \F_2^{kn}$ provides \emph{diffusion} and spreads the S-box influence over the whole state
        ...
        \begin{itemize}
            ...
            \item[] \textbf{Runtime}:
                \begin{itemize}
                    ...
                    \item Recursions: can stop after $r < n$ rounds
                    \item Overall: $\mathcal{O}(n^3)$ evaluations of $F$
                \end{itemize}
        \end{itemize}
    \end{minipage}
\end{frame}
