...
\bibliography{../cryptobib/abbrev3,../cryptobib/crypto,bibliography}
...
\begin{frame}{Future Work; Questions?}{Thank you for your attention!}
    \begin{columns}
        \begin{column}{0.45\textwidth}
            \begin{block}{Do your work!}
                Apply global optimization techniques that are known for years!\\[1em]

                (But thanks for the easy paper \Winkey)
            \end{block}
        \end{column}
        \begin{column}{0.45\textwidth}
            \begin{figure}[!htb]
